...
precision_weights_path = os.path.join('..', 'DIBCO_DATA_until_2019_pred_400_epochs', 'Weights', 'DIBCO'+str(DIBCO_year), str(img_number)+'_PWeights.dat')
recall_weights_path =  os.path.join('..', 'DIBCO_DATA_until_2019_pred_400_epochs', 'Weights', 'DIBCO'+str(DIBCO_year), str(img_number)+'_RWeights.dat')
...
#%%
image = np.array(Image.open(os.path.join('..', 'DIBCO_DATA_until_2019_pred_400_epochs', 'Images', 'DIBCO'+str(DIBCO_year), str(img_number)+'_BLEED_THROUGH_MASK.png')))
...
#%%
plt.imshow(np.array(Image.open(os.path.join('..', 'DIBCO_DATA_until_2019_pred_400_epochs', 'Images', 'DIBCO'+str(DIBCO_year), str(img_number)+'_BLEED_THROUGH_MASK.png')))[375:475,200:400], cmap='gray')
plt.axis('off')
plt.show()
plot_heatmap(normalized_precision[375:475,200:400], title="Precision Weight Heatmap")
plot_heatmap(normalized_recall[375:475,200:400], title="Recall Weight Heatmap")
# %%
